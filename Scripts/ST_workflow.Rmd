...
As a first step of this workflow, we load the `SpatialExperiment` object, that is available in the signifinder_workflow/Data directory. Then, we normalize the raw counts using the `logNormCounts` function from the `scater` package (version 1.24.0).
